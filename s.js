...
chrome.tabs.query({ currentWindow: true, active: true }, function (tabs) {
    ...
    url = `https://api.qrserver.com/v1/create-qr-code/?data=${tabs[0].url}&amp;size=100x100`;
...
//part 4 saving qr code
let qrsave = document.getElementById('QRbutton1');
qrsave.addEventListener('click', async function () {
    // console.log("clicked");
    // qrsave.innerText = "saving.."

    // await chrome.downloads.download({ url: `https://api.qrserver.com/v1/create-qr-code/?data=${tabs[0].url}&amp;size=100x100`, filename: "QRCode.png", saveAs: true });

    // qrsave.innerText = await "Saving";
